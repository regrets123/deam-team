...
openssl req -x509 -newkey rsa:2048 -nodes -days 2 \
  -subj "/CN=Wrong Demo CA" \
  -addext "basicConstraints=critical,CA:TRUE" \
  -addext "keyUsage=critical,keyCertSign,cRLSign" \
  -keyout generated/wrong-ca.key \
  -out generated/wrong-ca.crt >/dev/null 2>&1

chmod 600 generated/ca.key generated/server.key generated/wrong-ca.key
